...
#define CONFIG_SYS_PROMPT	__DATE__ " " __TIME__ " Custom Odroid  #"	/* Monitor Command Prompt */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"kernel_args=" \
		...
		"${rootopts} ${lpj} ${console} ${meminfo} ${opts} ${lcdinfo}\0"\
	"boot_fit=" \
