...
sensor_names = ["PDV_P8104.API.2006", "MLX90614ESF-DAA.Melexis.008-2013", "D6T-44L-06.Omron.2012", "Thermistor_NTC_PR103J2.US_Sensor.2003",
        ...
        "SHT75.Sensirion.5_2011", "HIH4030.Honeywell.2008", "GA1A1S201WP.Sharp.2007", "MAX4466.Maxim.2001"]
...
>>>>>>> 1b4a0619c26c18524967163a5aca1e14eb06f440
...
>>>>>>> 1b4a0619c26c18524967163a5aca1e14eb06f440
        ...
        # pass parameter object's name as argument for functional parameters
        # reading_obj.add_parameter(param_obj) # Example
        ...
        # pass parameter object's name as argument for non-functional parameters
        # sensor_obj.add_parameter(param_obj) # Example
        ...
        # Pass the reading object's name as argument
        # sensor_obj.add_reading(reading_obj) # Example
        ...
        # When you are done with adding all the readings call this function with the sensor object
        # write_to_config_file(sensor_obj) # Example
