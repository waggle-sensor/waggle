 ...
 */
 ...
 function update() {
 	...
 	data.open("GET", "http://127.0.0.1:31338/Volumes/Argonne/repos/waggle_version0.3_nathan/www/sensor_page/data/current/current.txt", true);
