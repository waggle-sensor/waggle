...
%     GP2Y1010AU0F & integer & ppm & \\  %%%%% NOT IN ANY VERSION
    %HIH4030 & \%RH & \%RH & \\  %%%% NOT IN V2
...
%     D6T & \textit{Seventeen} \degree C values & \textit{Seventeen} \degree C values & \\ %%% NOT IN ANY VERSION
%     MLX90614 & \degree F & \degree C & \\ %%% NOT IN ANY VERSION
