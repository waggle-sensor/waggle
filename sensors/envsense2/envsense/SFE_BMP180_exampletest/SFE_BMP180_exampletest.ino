...
void loop()
{
  ...
  SerialUSB.println();
  SerialUSB.print("provided altitude: ");
  SerialUSB.print(ALTITUDE,0);
  SerialUSB.print(" meters, ");
  SerialUSB.print(ALTITUDE*3.28084,0);
  ...
  if (status != 0)
  {
    ...
    if (status != 0)
    {
      ...
      SerialUSB.print((9.0/5.0)*T+32.0,2);
      SerialUSB.println(" deg F");
      ...
      if (status != 0)
      {
        ...
        {
          // Print out the measurement:
          SerialUSB.print("absolute pressure: ");
          SerialUSB.print(P,2);
          SerialUSB.print(" mb, ");
          SerialUSB.print(P*0.0295333727,2);
          ...
          SerialUSB.print("relative (sea-level) pressure: ");
          SerialUSB.print(p0,2);
          SerialUSB.print(" mb, ");
          SerialUSB.print(p0*0.0295333727,2);
          SerialUSB.println(" inHg");
          ...
          SerialUSB.print("computed altitude: ");
          SerialUSB.print(a,0);
          SerialUSB.print(" meters, ");
          SerialUSB.print(a*3.28084,0);
          SerialUSB.println(" feet");
        }
