...
void setup()
{
    ...
    SerialUSB.println("MMA8452 Basic Example");

    Wire1.begin(); //Join the bus as a master
...
void loop()
{
    ...
    for (int i = 0 ; i < 3 ; i++)
    {
        SerialUSB.print(accelG[i], 4);  // Print g values
        SerialUSB.print("\t");  // tabs in between axes
    }
    SerialUSB.println();
