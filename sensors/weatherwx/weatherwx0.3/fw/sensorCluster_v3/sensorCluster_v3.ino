// Sensor Cluster Code, version 3
// Using interrupts, gets readings from two time-sensitive sensors (noise and acceleration) 25 times per second 
// and gets readings from all other sensors once every second
