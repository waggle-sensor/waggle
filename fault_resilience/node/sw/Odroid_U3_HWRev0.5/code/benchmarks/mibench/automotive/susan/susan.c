...
typedef  struct cornet_list_t {int x,y,info, dx, dy, I;} CORNER_LIST[MAX_CORNERS];
...
void
put_image(char filename[100], uchar *in, int x_size, int y_size)
{
FILE  *fd;
...
void
susan_smoothing(int three_by_three, uchar *in, float dt, int x_size, int y_size, uchar *bp)
{
/* {{{ vars */
